...
contract StrategyNative_REBASE is ERC20, Ownable, ReentrancyGuard, Pausable {
    ...
    address public token0Address = 0x0000000000000000000000000000000000000000; // not used
    address public token1Address = 0x0000000000000000000000000000000000000000; // not used
    ...
    uint256 public constant lastEarnBlock = 0;

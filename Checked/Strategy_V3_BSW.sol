...
contract STRATBSW is ERC20, Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant UNI_ROUTER_ADDRESS =
        0x3a6d8cA21D1CF76F653A67577FA0D27453350dD8; // uniswap, pancakeswap, biswap etc
    address public buybackRouterAddress =
        0x10ED43C718714eb63d5aA57B78B54704E256024E; // uniswap, pancakeswap, biswap etc
    ...
    constructor(
        ...
        if (IS_AUTO_COMP) {
            ...
            FARM_CONTRACT_ADDRESS = 0xDbc1A13490deeF9c3C12b44FE77b503c1B061739;
            pid = _pid;
